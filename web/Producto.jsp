<%-- 
    Document   : prod
    Created on : 15/10/2021, 11:36:26
    Author     : User
--%>
...
<html>
    ...
    <body>
                ...
                <input type="text" name="txt_id_producto" id="txt_id_producto" class="form-control" value="0" readonly="">
                              ...
                              <label for="lbl_producto"><b>formulario productos:</b></label>
                              <input type="text" class="form-control" name="txt_producto" id="txt_producto"  aria-label="Producto">
                           
                              <label for="lbl_existencia"><b>Existencias:</b></label>
                              <input type="number" class="form-control" name="txt_existencia" id="txt_existencia">
                
                    <label for="lbl_descripcion"><b>Descripción del producto:</b></label>
                    <input type="text" name="txt_descripcion" id="txt_descripcion" class="form-control" >
                    
                                <label for="lbl_costo"><b>Precio del costo:</b></label>
                                ...
                                <label for="lbl_venta"><b>Precio de la venta:</b></label>
                              

                                    <span class="input-group-text" id="basic-addon1">Q</span>    
                                    <input type="number" step="0.01" name="txt_venta" id="txt_venta" class="form-control" >
                             
                    
                    <label for="lbl_descripcion"><b>Imagen del producto</b></label>
                    <input type="text" name="txt_imagen" id="txt_imagen" class="form-control" >
                                ...
                                %>
                                    ...
                                    <div class="col-md-6">
                                    <label for="lbl_date"><b>La fecha de ingreso</b></label>
                    ...
                    <div class="row">
                        <div class="row g-6">
                            <div class="d-grid gap-2 col-4 mx-auto">
                                <button name="btn_agregar_productos" id="btn_agregar_productos" class="btn btn-primary" value="agregar_producto">AGREGAR</button>
                            </div>
                                  <br>
                            <div class="d-grid gap-2 col-4 mx-auto">
                                <button name="btn_modificar_productos" id="btn_modificar_productos" class="btn btn-primary" value="modificar_producto">MODIFICAR</button>
                            </div>
                            <br>
                            <div class="d-grid gap-2 col-4 mx-auto">
                                <button name="btn_eliminar_productos" id="btn_eliminar_productos" class="btn btn-primary" value="eliminar_producto">ELIMINAR</button>
                            </div>
                            <center>
                            <div class="list-group">
                                    ...
                                    <a href="Marcas.jsp" class="list-group-item list-group-item-action">MARCAS FORM</a>
                                    <a href="index.jsp" class="list-group-item list-group-item-action">PAGINA CENTRAL</a>
                                  </div>
                            </center>
                        </div>
                    </div>
